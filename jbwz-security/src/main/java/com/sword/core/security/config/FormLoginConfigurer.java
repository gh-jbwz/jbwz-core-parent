...
import com.jbwz.core.security.filter.FormLoginFilter;
...
public class FormLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
        AbstractAuthenticationFilterConfigurer<H, FormLoginConfigurer<H>, FormLoginFilter> {
    ...
    public FormLoginConfigurer() {
        ...
        loginTypeParameter("loginType");
    }

    /**
     * <p>
     * Specifies the URL to send users to if login is required. If used with {@link
     * WebSecurityConfigurerAdapter} a default login page will be generated when this attribute is not
     * specified.
     * </p>
     *
     * <p>
     * If a URL is specified or this is not being used in conjuction with {@link
     * WebSecurityConfigurerAdapter}, users are required to process the specified URL to generate a
     * login page. In general, the login page should create a form that submits a request with the
     * following requirements to work with {@link FormLoginFilter}:
     * </p>
     *
     * <ul>
     ...
     * <p>
     * Login pages can be rendered with any technology you choose so long as the rules above are
     * followed. Below is an example login.jsp that can be used as a quick start when using JSP's or
     * as a baseline to translate into another view technology.
     *
     * <pre>
     ...
     *        &lt;input typeCode="text" id="username" name="username"/&gt;
     *        &lt;/p&gt;
     *        &lt;p&gt;
     *        &lt;label for="password"&gt;Password&lt;/label&gt;
     *        &lt;input typeCode="password" id="password" name="password"/&gt;
     *        &lt;/p&gt;
     *        &lt;!-- if using RememberMeConfigurer make sure remember-me matches RememberMeConfigurer#rememberMeParameter --&gt;
     *        &lt;p&gt;
     *        &lt;label for="remember-me"&gt;Remember Me?&lt;/label&gt;
     *        &lt;input typeCode="checkbox" id="remember-me" name="remember-me"/&gt;
     *        &lt;/p&gt;
     *        &lt;div&gt;
     *            &lt;button typeCode="submit" class="btn"&gt;Log in&lt;/button&gt;
     *        &lt;/div&gt;
     *    &lt;/fieldset&gt;
     * &lt;/form&gt;
     * </pre>
     ...
     * <p>
     * Updating this value, also impacts a number of other default values. For example, the following
     * are the default values when only formLogin() was specified.
     *
     * <ul>
    ...
    /**
     * The HTTP parameter to look for the username when performing authentication. Default is
     * "username".
     *
     * @param usernameParameter the HTTP parameter to look for the username when performing
     *                          authentication
     * @return the {@link FormLoginConfigurer} for additional customization
     */
    ...
    /**
     * The HTTP parameter to look for the password when performing authentication. Default is
     * "password".
     *
     ...
     * @return
     */
    public FormLoginConfigurer<H> loginTypeParameter(String loginType) {
        getAuthenticationFilter().setLoginTypeParam(loginType);
        return this;
    }
